...
(function(root, factory) {
  ...
  var QUESTIONS = [
    ...
    {id:8, dim:'PS', reverse:false, ko:'기념일·이벤트를 미리 챙기고 준비하는 편이다.', en:'I tend to remember anniversaries and prepare little events ahead of time.', ja:'記念日やイベントは事前に覚えて準備するほうだ。', zh:'我会提前记得纪念日和特别活动，并做些准备。', es:'Suelo recordar aniversarios y preparar detalles con tiempo.'},
