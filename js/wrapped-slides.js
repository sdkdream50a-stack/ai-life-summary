  ...
  t(key) {
    const translations = {
      ...
      ja: {
        ...
        testsCompleted: '回のテスト完了',
        yourSoulType: 'あなたのソウルタイプ',
        times: '回',
        bestStreak: '最高ストリーク',
        days: '日連続',
        bestCompatibility: '最高の相性',
        match: 'マッチ',
        levelJourney: 'レベルの旅',
        totalXp: '総XP',
      ...
      es: {
        ...
        yourSoulType: 'Tu Tipo de Alma',
        times: 'veces',
        bestStreak: 'Mejor Racha',
        days: 'días',
        bestCompatibility: 'Mejor Compatibilidad',
        match: 'Coincidencia',
        levelJourney: 'Viaje de Nivel',
        totalXp: 'XP Total',
        badgesEarned: 'Insignias Obtenidas',
        andMore: 'más',
        yourWrapped: 'Mi Resumen',
