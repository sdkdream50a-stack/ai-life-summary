...
(function(root, factory) {
  ...
  var TYPES = {
    ...
    PSE: {emoji:'🔬', name:'깊이 파는 장인', tagline:'한 우물을 정교하게.', desc:'관심 분야를 계획적으로 깊게 파고드는 유형. 전문성과 완성도가 강점.', strengths:['전문성','꼼꼼함','끈기'], compatible:['ASE','ATE'], i18n:{en:{name:'Deep Craftsperson',tagline:'Refine one well, deeply.',desc:'You dig into your field of interest with deliberate depth. Expertise and polish are your strengths.',strengths:['Expertise','Thoroughness','Persistence']},ja:{name:'深掘りする職人',tagline:'一つの分野をとことん究める。',desc:'関心のある分野を計画的に深く掘り下げるタイプ。専門性と完成度が強みです。',strengths:['専門性','丁寧さ','粘り強さ']},zh:{name:'深耕型匠人',tagline:'把一口井挖得精细。',desc:'你会有计划地深入钻研自己感兴趣的领域。专业度和完成度是你的强项。',strengths:['专业性','细致','韧性']},es:{name:'Artesano/a profundo/a',tagline:'Profundiza con precisión en lo tuyo.',desc:'Exploras tu área de interés con profundidad y planificación. Tu fortaleza está en la especialización y el acabado.',strengths:['Especialización','Detalle','Perseverancia']}}},
