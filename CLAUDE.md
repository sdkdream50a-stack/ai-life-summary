...
### ⚠️ 콘텐츠 무결성 가이드라인 (필수 준수)

블로그 글 작성 시 다음 사항을 **반드시** 지켜야 합니다:

#### 금지 사항
1. **허위 전문가/저자 금지**
   - ❌ "Dr. 김민수", "박지현 박사" 등 가상의 전문가 이름 사용 금지
   - ❌ "Dr. AI Research Team" 등 허위 학위 타이틀 금지
   - ❌ "전문가 검토 완료" 등 허위 검증 주장 금지
   - ✅ 저자는 반드시 "AI Test Lab 편집팀"으로 표기

2. **허위 연구/통계 금지**
   - ❌ "Harvard 2024년 연구에 따르면..." (존재하지 않는 연구 인용 금지)
   - ❌ "47% 감소", "65% 향상" 등 출처 없는 구체적 수치 금지
   - ❌ "Manchester University의 10만 쌍 연구" 등 검증 불가능한 연구 인용 금지
   - ✅ 구체적 수치 인용 시 반드시 실제 논문 출처 명시

3. **참고문헌 정확성**
   - ❌ 연도, 권호, 페이지가 불일치하는 가짜 인용 금지
   - ✅ 인용하는 모든 논문은 실제 존재하는지 확인
   - ✅ 논문 형식: 저자 (연도). 제목. 저널명, 권(호), 페이지.

#### 허용되는 표현
- "연구들에 따르면..." (일반적 참조)
- "유의미하게 높은/낮은 것으로 나타났습니다" (구체적 수치 대신)
- "여러 연구에서 관찰되었습니다" (특정 기관 명시 없이)

#### 검증된 참고문헌 예시
- Youyou, W., et al. (2015). PNAS - AI 성격 분석 연구 (실제 존재)
- Gottman, J. M. (1999). Seven Principles for Making Marriage Work (실제 존재)
- Erickson, K. I., et al. (2011). PNAS - 운동과 해마 연구 (실제 존재)
